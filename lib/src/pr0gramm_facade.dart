...
class Pr0gramm
  ...
  Pr0gramm(Dio dio)
      : _profileApi = ProfileApi(dio),
        ...
        _pr0grammCookieManager = dio.interceptors
            .firstWhere((interceptor) => interceptor is Pr0grammCookieManager);
  ...
  @override
  Future<Login> login(
          String username, String password, String token, String captcha) =>
      _userApi.login(username, password, token, captcha);
  ...
  @override
  Future<Logout> logout({String nonce, String id}) => _userApi.logout(
      id: id ?? _pr0grammCookieManager.pr0grammId,
  ...
  @override
  Future<UserInfo> changePassword(String currentPassword, String password,
          {String nonce}) =>
      _userApi.changePassword(currentPassword, password,
          nonce: nonce ?? _pr0grammCookieManager.pr0grammNonce);
  ...
  /// You can provide [nonce] directly, but it is not recommended.
  @override
  Future<UserInfo> requestEmailChange(String currentPassword, String email,
          {String nonce}) =>
      _userApi.requestEmailChange(currentPassword, email,
          nonce: nonce ?? _pr0grammCookieManager.pr0grammNonce);
  ...
  /// You can provide [nonce] directly, but it is not recommended.
  @override
  Future<UserInfo> changeSiteSettings(bool likesArePublic, bool favUpvote,
          bool showAds, UserStatus userStatus, Theme theme, {String nonce}) =>
      _userApi.changeSiteSettings(
          likesArePublic, favUpvote, showAds, userStatus, theme,
          nonce: nonce ?? _pr0grammCookieManager.pr0grammNonce);
  ...
  /// You can provide [nonce] directly, but it is not recommended.
  @override
  Future<UserInfo> changeSiteSecurity(bool deviceMail, {String nonce}) =>
      _userApi.changeSiteSecurity(deviceMail,
          nonce: nonce ?? _pr0grammCookieManager.pr0grammNonce);

  /// Get users
  @override
  Future<FollowUserWrapper> getFollowedUsers(ItemFlags flags) =>
      _userApi.getFollowedUsers(flags);
  ...
  @override
  Future<ProfileCommentWrapper> getComments(
          ItemFlags flags, DateTime before, String name) =>
      _profileApi.getComments(flags, before, name);

  /// Get liked comments
  ///
  /// Filter liked comments by [flags], [before] and user[name].
  @override
  Future<LikedCommentWrapper> getCommentLikes(
          ItemFlags flags, DateTime before, String name) =>
      _profileApi.getCommentLikes(flags, before, name);
  ...
  /// You can provide [nonce] directly, but it is not recommended.
  @override
  Future<Subscribe> subscribeToUser(String name, {String nonce}) =>
      _profileApi.subscribeToUser(name,
          nonce: nonce ?? _pr0grammCookieManager.pr0grammNonce);
  ...
  @override
  Future<Subscribe> unsubscribeFromUser(String name, {String nonce}) =>
      _profileApi.unsubscribeFromUser(name,
          nonce: nonce ?? _pr0grammCookieManager.pr0grammNonce);
  ...
  /// You can provide [nonce] directly, but it is not recommended.
  @override
  Future<Follow> followUser(String name, {String nonce}) => _profileApi
      .followUser(name, nonce: nonce ?? _pr0grammCookieManager.pr0grammNonce);
  ...
  /// You can provide [nonce] directly, but it is not recommended.
  @override
  Future<Follow> unfollowUser(String name, {String nonce}) => _profileApi
      .unfollowUser(name, nonce: nonce ?? _pr0grammCookieManager.pr0grammNonce);
  ...
  /// You can provide [nonce] directly, but it is not recommended.
  @override
  Future<Block> blockUser(String name, {String nonce}) => _profileApi
      .blockUser(name, nonce: nonce ?? _pr0grammCookieManager.pr0grammNonce);
  ...
  /// You can provide [nonce] directly, but it is not recommended.
  @override
  Future<Block> unblockUser(String name, {String nonce}) => _profileApi
      .unblockUser(name, nonce: nonce ?? _pr0grammCookieManager.pr0grammNonce);
  ...
  /// You can provide [nonce] directly, but it is not recommended.
  @override
  Future<void> voteItem(int id, Vote vote, {String nonce}) => _itemsApi
      .voteItem(id, vote, nonce: nonce ?? _pr0grammCookieManager.pr0grammNonce);
  ...
  @override
  Future<Uploaded> uploadWithFormData(FormData formData) =>
      _itemsApi.uploadWithFormData(formData);
  ...
  Future<Uploaded> upload(String filePath) =>
      _itemsApi.uploadWithFormData(FormData.fromMap({
        'image': MultipartFile.fromFileSync(filePath,
            filename: filePath,
            contentType: MediaType.fromFilePath(filePath).convert())
      }));
  ...
  /// You can provide [nonce] directly, but it is not recommended.
  @override
  Future<Posted> post(String imageUrl, ItemFlag sfwstatus, String tags,
  ...
  /// Uses [_pr0grammCookieManager] to get [nonce].
  /// You can provide [nonce] directly, but it is not recommended.
  Future<Posted> postWithScheduledDateTime(String imageUrl, ItemFlag sfwstatus,
          String tags, String comment, String key,
          {String nonce,
          bool checkSimilar = true,
          bool processAsync = true,
          DateTime scheduled}) =>
  ...
  Future<Posted> uploadAndPost(
    ...
    return postWithScheduledDateTime(
        null, sfwstatus, tags, comment, uploaded.key,
        checkSimilar: checkSimilar,
        processAsync: processAsync,
        scheduled: scheduled,
        nonce: nonce ?? _pr0grammCookieManager.pr0grammNonce);
  ...
  /// You can provide [nonce] directly, but it is not recommended.
  @override
  Future<AddedTags> addTag(String tags, int itemId, {String nonce}) =>
      _tagsApi.addTag(tags, itemId,
          nonce: nonce ?? _pr0grammCookieManager.pr0grammNonce);
  ...
  /// You can provide [nonce] directly, but it is not recommended.
  @override
  Future<void> voteComment(int id, Vote vote, {String nonce}) =>
      _commentsApi.voteComment(id, vote,
          nonce: nonce ?? _pr0grammCookieManager.pr0grammNonce);
  ...
  /// You can provide [nonce] directly, but it is not recommended.
  @override
  Future<void> postComment(String comment, int itemId,
          {String nonce, int parentId = 0}) =>
      _commentsApi.postComment(comment, itemId,
          parentId: parentId,
          nonce: nonce ?? _pr0grammCookieManager.pr0grammNonce);
  ...
  /// You can provide [nonce] directly, but it is not recommended.
  @override
  Future<void> favComment(int id, {String nonce}) => _commentsApi.favComment(id,
      nonce: nonce ?? _pr0grammCookieManager.pr0grammNonce);
  ...
  /// You can provide [nonce] directly, but it is not recommended.
  @override
  Future<void> unfavComment(int id, {String nonce}) => _commentsApi
      .favComment(id, nonce: nonce ?? _pr0grammCookieManager.pr0grammNonce);
  ...
  /// You can provide [nonce] directly, but it is not recommended.
  @override
  Future<void> report(String reason, String customReason,
          {String nonce, int userId, int commentId, int itemId}) =>
      _contactApi.report(reason, customReason,
          nonce: nonce ?? _pr0grammCookieManager.pr0grammNonce,
          userId: userId,
          commentId: commentId,
          itemId: itemId);
  ...
  /// You can provide [nonce] directly, but it is not recommended.
  @override
  Future<void> send(String email, String subject, String message) =>
      _contactApi.send(email, subject, message);

  /// Get your whole inbox
  @override
  Future<MessageWrapper> getAllInbox({DateTime older}) =>
      _inboxApi.getAllInbox(older: older);
  ...
  Future<MessageWrapper> getInboxNotifications() =>
      _inboxApi.getInboxNotifications();

  /// Get only private conversations
  @override
  Future<ConversationWrapper> getInboxConversations() =>
      _inboxApi.getInboxConversations();

  /// Get messages with a user
  @override
  Future<MessageWith> getInboxMessagesWith(String name) =>
      _inboxApi.getInboxMessagesWith(name);
  ...
  /// You can provide [nonce] directly, but it is not recommended.
  @override
  Future<void> sendMessage(String name, String comment, {String nonce}) =>
      _inboxApi.sendMessage(name, comment,
          nonce: nonce ?? _pr0grammCookieManager.pr0grammNonce);
  ...
  /// You can provide [nonce] directly, but it is not recommended.
  @override
  Future<void> voteTag(int id, int vote, {String nonce}) => _tagsApi
      .voteTag(id, vote, nonce: nonce ?? _pr0grammCookieManager.pr0grammNonce);

  /// Get a list of possible ban reasons
  @override
  Future<BanReasonWrapper> getBanReasons(BanReasonType type) =>
      _faqApi.getBanReasons(type);

  /// Load a thumb from [urlPath] and save it to [savePath]
  @override
  Future<void> loadThumb(String urlPath, String savePath) =>
      _thumbApi.loadThumb(urlPath, savePath);

  /// Load an image from [urlPath] and save it to [savePath]
  @override
  Future<void> loadImage(String urlPath, String savePath) =>
      _imageApi.loadImage(urlPath, savePath);

  /// Load a video from [urlPath] and save it to [savePath]
  @override
  Future<void> loadVideo(String urlPath, String savePath) =>
      _videoApi.loadVideo(urlPath, savePath);

  /// Load a badge from [urlPath] and save it to [savePath]
  @override
  Future<void> loadBadge(String urlPath, String savePath) =>
      _badgeApi.loadBadge(urlPath, savePath);
}
