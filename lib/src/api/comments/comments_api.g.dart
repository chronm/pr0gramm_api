...
class _CommentsApi implements CommentsApi {
  ...
  Future<void> postComment(comment, itemId, {nonce, parentId}) async {
    ...
    final queryParameters = <String, dynamic>{};
    queryParameters.removeWhere((k, v) => v == null);
    final _data = {'comment': comment, 'itemId': itemId, '_nonce': nonce, 'parentId': parentId};
    _data.removeWhere((k, v) => v == null);
    await _dio.request<void>('/post', queryParameters: queryParameters, options: RequestOptions(method: 'POST', headers: <String, dynamic>{}, extra: _extra, baseUrl: baseUrl), data: _data);
    return null;
  }
  ...
  Future<void> favComment(id, {nonce}) async {
    ...
    _data.removeWhere((k, v) => v == null);
    await _dio.request<void>('/fav', queryParameters: queryParameters, options: RequestOptions(method: 'POST', headers: <String, dynamic>{}, extra: _extra, baseUrl: baseUrl), data: _data);
    return null;
  }
  ...
  Future<void> unfavComment(id, {nonce}) async {
    ...
    final _data = {'id': id, '_nonce': nonce};
    _data.removeWhere((k, v) => v == null);
    await _dio.request<void>('/unfav', queryParameters: queryParameters, options: RequestOptions(method: 'POST', headers: <String, dynamic>{}, extra: _extra, baseUrl: baseUrl), data: _data);
    return null;
  }
}
