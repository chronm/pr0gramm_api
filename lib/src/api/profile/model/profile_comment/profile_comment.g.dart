...
Map<String, dynamic> _$ProfileCommentToJson(ProfileComment instance) =>
    <String, dynamic>{
      'id': instance.id,
      'up': instance.up,
      'down': instance.down,
...
ProfileCommentWrapper _$ProfileCommentWrapperFromJson(
...
Map<String, dynamic> _$ProfileCommentWrapperToJson(
        ProfileCommentWrapper instance) =>
    <String, dynamic>{
